                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="js-example-basic-multiple" class="form-control js-example-basic-single" name="user_id[]">
                                                <option selected disabled value="AL">Type to search</option>
                                                <option value="WY">Wyoming</option>
                                                <option value="WY">aul</option>
                                                <option value="WY">agat</option>
                                                <option value="WY">keren</option>
                                              </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <select class="form-control" id="id_dasawisma" name="status[]">
                                                    ...
                                                    <option value="kepala">Ibu</option>
                                                    <option value="kepala">Anak</option>
